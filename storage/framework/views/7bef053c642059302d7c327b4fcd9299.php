...
<div class="container">
    ...
    <div class="row">		
      <div class="col-lg-4">
      <h6><?php echo e(__('Newsletter')); ?></h6> 
    <p><?php echo e(__('Subscribe to our newsletter and stay updated.')); ?></p>	
      </div>
      <div class="col-lg-8">
      ...
      <?php echo e(csrf_field()); ?>
		  ...
		  <input type="text" class="form-control" placeholder="<?php echo e(__('Name')); ?>" name="name" id="name" required="required">
			<input type="text" class="form-control" placeholder="<?php echo e(__('Email')); ?>" name="email" id="email" required="required">
		  <div class="input-group-append">
			<button class="btn btn-default" type="button" id="send_subscription_form"><?php echo e(__('Subscribe')); ?></button>			  
		  </div>
		</div> 
...
<?php $__env->stopPush(); ?><?php /**PATH E:\xampp\htdocs\dev\codecanyon\jobsportal\resources\views/includes/subscribe.blade.php ENDPATH**/ ?>