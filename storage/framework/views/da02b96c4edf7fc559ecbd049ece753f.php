<div class="section homeblogposts">
    <div class="container"> 
        ...
        <div class="titleTop">
            ...
            <h3><?php echo e(__('Latest')); ?> <span><?php echo e(__('Blogs')); ?></span></h3>
        </div>
        <!-- title end -->
           ...
           <?php if(null!==($blogs)): ?>
                        ...
                        <li class="col-lg-4">
                            <div class="bloginner">
                                ...
                                <p><?php echo \Illuminate\Support\Str::limit($blog->content, $limit = 150, $end = '...'); ?></p>
        ...
        <!--view button-->
        <div class="viewallbtn"><a href="<?php echo e(route('blogs')); ?>"><?php echo e(__('View All Blog Posts')); ?></a></div>
        <!--view button end--> 
    </div>
</div><?php /**PATH E:\xampp\htdocs\dev\codecanyon\jobsportal\resources\views/includes/home_blogs.blade.php ENDPATH**/ ?>